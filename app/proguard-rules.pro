...
-keep class xyz.mxlei.mvvmx.http.BaseResponse { *; }
...
#---------------------------------4.反射相关的类和方法-----------------------
-keep public class * extends xyz.mxlei.mvvmx.base.BaseActivity{ *; }
-keep public class * extends xyz.mxlei.mvvmx.base.BaseFragment{ *; }
...
-keep class xyz.mxlei.mvvmx.widget.** { *; }
